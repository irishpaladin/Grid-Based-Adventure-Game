...
public:
	...
	//  Default Constructor
	//
	//  Purpose: To create a Player with sensible values
	//  Parameter(s): N/A
	//  Precondition: N/A
	//  Returns: N/A
	...
	//  Copy Constructor
	//
	//  Purpose: To create a Player base on exixting Player
	//  Parameter(s):
	//    <1> original: Player that will be copied
	//  Precondition: N/A
	//  Returns: N/A
	//  Side Effect: The Player will be initialized based on 'original' player
	//
	...
	//  Assignment Operator
	//
	//  Purpose: To reinitialize Player base on existing Player
	//  Parameter(s):
	//    <1> original: Player that will be copied
	//  Precondition: N/A
	//  Returns: N/A
